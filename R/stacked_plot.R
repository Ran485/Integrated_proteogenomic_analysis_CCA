...
stacked_barplot <- function(data = data, target = 'LBC_circulation',category_var_colname = 'Lateral_branch_blood_supply'){
  ...
  # title = paste0(category_var_colname,'_', 'pval', '_', signif(p_val,4))
  ## 百分数占比
